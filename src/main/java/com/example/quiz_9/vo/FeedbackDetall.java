...
public class FeedbackDetall {
	...
	public FeedbackDetall() {
		super();
	}

	public FeedbackDetall(String quizName, String description, LocalDate startDate, LocalDate endDate, String userName,
